...
function setup() {
	 ...
	 * references of wd_s
	 */
	load_theme_textdomain( 'nda', get_template_directory() . '/build/languages' );
	...
	register_nav_menus(
		[
			'primary' => esc_html__( 'Primary Menu', 'nda' ),
			'footer'  => esc_html__( 'Footer Menu', 'nda' ),
			'mobile'  => esc_html__( 'Mobile Menu', 'nda' ),
		]
	);
