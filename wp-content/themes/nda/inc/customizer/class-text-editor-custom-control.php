...
final class Text_Editor_Custom_Control extends \WP_Customize_Control {
	...
	protected function enqueue_scripts() {
		...
		wp_enqueue_script( 'nda-customize-editor-js', get_template_directory_uri() . '/inc/customizer/assets/scripts/tinymce.js', [ 'jquery' ], '1.0.0', true );
	}
	...
	protected function add_footer_scripts() {
		do_action( 'nda_admin_print_footer_scripts' );
	}
}
